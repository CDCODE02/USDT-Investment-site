...
<head>
    ...
    <title>VERDIENEN - Bitcoin And Crypto Currency HTML Template </title>
    <!-- Bootstrap core CSS -->
    <link href="assets/bootstrap/css/bootstrap.min.css" rel="stylesheet">
    <!-- Google Font  -->    <link rel="shortcut icon" type="image/x-icon" href="images/logo.jpg" />
            ...
            <div class="row justify-content-center gutter-vr-30px">
                <div class="ath-container m-0">
                    <div class="ath-body">
                        ...
                        <?php } ?>
                        <form action="action/main_work.php?option=enter_email" method="POST">
                            <div class="field-item">
                                <div class="field-wrap">
                                    <input type="text" class="input-bordered" name="email" placeholder="Your Email" value="<?php if (isset($_SESSION{'email'})) {echo $_SESSION['email'];}?>">
                                </div>
                            </div>
