				...
				<div class="row">
					<div class="col-12 text-center">
						<div class="single-page-title">
							<h2>Latest Post</h2>
							<p>Your Money will work for you here with full maximized profits</p>
						</div>
					</div>
				</div>
				<!-- end row-->
				...
				<div class="col-lg-8 col-md-8 col-12">
					<div class="single-blog mb-5 wow fadeInUp animated">
						...
						<div class="single-blog-dec">
							<a href="#"><h4>Final Testing for ETC Support on STABLEEARNER</h4></a>
							<span class="post-date"><i class="icofont icofont-calendar"></i></span>
					...
					<div class="single-blog mb-5 wow fadeInUp animated">
						...
						<div class="single-blog-dec">
							<a href="#"><h4>What we accomplished at Coinbase</h4></a>
							<span class="post-date"><i class="icofont icofont-calendar"></i></span>
							<span class="post-comment"><i class="far fa-comment"></i> 4 comments</span>
							<span class="allpost-cata"><i class="icofont icofont-ui-tag"></i>currency, exchange</span>
							<p>
							Your Money will work for you here with full maximized profits.
STABLEEARNER Investment has created many safety functions for these operations
								<a href="#">[...]</a>
							</p>
							<div class="single-blog-admin">
								<div class="single-blog-admin-img">
				...
				<div class="col-lg-4 col-md-4 col-sm-12 col-12 mb-lg-0 mb-md-0 mb-5 pl-lg-5 pl-md-5 pl-sm-2 pl-2">
					...
					<div class="widget cat_wid mb-5">
						...
						<div class="widget-inner mt-5">
							<div class="category-menu">
								<ul>
									<li><a href="#">USDT <span class="float-right">(4)</span></a></li>
									<li><a href="#">Cryptocurrency <span class="float-right">(3)</span></a></li>
									<li><a href="#">Trading <span class="float-right">(5)</span></a></li>
									<li><a href="#">coins <span class="float-right">(2)</span></a></li>
					...
					<div class="widget tag_wid">
						...
						<div class="widget-inner mt-5">
							<div class="tag-list">
								<ul>
									<li><a href="#">USDT <span>4</span></a></li>
									<li><a href="#">Trading <span>3</span></a></li>
									<li><a href="#">Coin <span>5</span></a></li>
									<li><a href="#">Invest <span>2</span></a></li>
									<li><a href="#">Trending <span>7</span></a></li>
									<li><a href="#">Currency <span>4</span></a></li>
									<li><a href="#">Stable coins  <span>1</span></a></li>
                ...
                <div class="row">
                    <div class="col-lg-3 col-md-6 col-sm-12 col-12 mb-lg-0 mb-md-5 mb-5 footer-widget">
                        ...
                        <div class="about mb-2">
                            <p>STABLEEARNER Investment is well reputed company which main businesse is USDT investment. We have experienced traders who are working over the year in this field.</p>
                        </div>
