...
<body>
					...
					<div class="col-lg-4 col-md-12 col-sm-12 col-12">
						<div class="info-menu">
							<ul>
								...
								<li><a href="index.php"><i class="icofont icofont-hand-drag2"></i> <b>Help</b> </a></li>
								<li><a href="contact.php"><i class="icofont icofont-live-support"></i> <b>Support</b> </a></li>
							</ul>
						</div>
					</div> 
					<!-- end col -->
	...
	<section id="page-banner">
		<div class="single-page-title-area overlay" data-background="assets/img/bg/slide1.jpeg">
			<div class="auto-container">
				<div class="row">
					<div class="col-12 text-center">
						<div class="single-page-title">
							<h2>About STABLEEARNER</h2>
							<p>STABLEEARNER highly draws attention to safety of its clients investments</p>
						</div>
					</div>
				</div>
				<!-- end row-->
				...
				<div class="col-lg-4 col-md-4 col-12 mb-lg-0 mb-md-0 mb-5">
					<div class="blockquote-wrapper">
						...
						<blockquote class="blockquote">
							<p><i class="icofont icofont-quote-left"></i>I Have Traded With A Lot Of PlatForms, Never Have I Encountered A Trading Service As Reliable As STABLEEARNER Investment. <i class="icofont icofont-quote-right"></i></p>
				...
				<div class="col-lg-6 col-md-6 col-12 mb-5">
							<div class="single-wcus">
								...
								<div class="single-wcus-text">
									...
									<p>A good strategy guarantees a viable return come process. At STABLEEARNER Investment, we utilize the best strategies to ensure that our Investors have maximum profit</p>
								</div>
							</div>
						</div>
				<!-- end single chooseus -->	 
    ...
    <section id="counter" class="section-padding overlay counter-section section-back-image-2" data-background="assets/img/bg/cbg.jpeg">
        <div class="container"> 
			...
			<div class="row">
				<div class="col-12 text-center">
					<div class="calltoaction-two-wrap mb-4">
						...
						<p>It means that our analysts and experts in economics and finance do a huge work of monitoring,<br> analysis and forecasting the situation on the markets.</p>
					</div>
					<a href="contact.php" class=" wow fadeInDown btn-style btn-border btn-border-3">Contact Us <i class="icofont icofont-hand-right"></i></a>
				</div>
				<!-- end col -->
				<!-- end col -->
			</div>
                ...
                <div class="row">
                    <div class="col-lg-3 col-md-6 col-sm-12 col-12 mb-lg-0 mb-md-5 mb-5 footer-widget">
                        ...
                        <div class="about mb-2">
                            <p>STABLEEARNER Investment is well reputed company which main business is USDT investment. We have experienced traders who are working over the year in this field.</p>
                        </div>
