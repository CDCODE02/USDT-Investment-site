...
<head>
    ...
    <title>VERDIENEN GLOBAL- Bitcoin And Crypto Currency Company</title>
    <!-- Bootstrap core CSS -->
...
<body>
	...
	<div id="page-preloader">
		<div class="theme-loader">Verdienen</div>
	</div>
	<!-- END PRELOADER --> 
			...
			<div class="auto-container">
				<div class="row">
					<div class="col-lg-5 col-md-3 col-sm-6 col-7 mx-auto pl-0 mb-lg-0 mb-5">
						<div class="logo">
							<a href="index.php">
							<img class="img-fluid" src="images/IMG-20220428-WA0063.jpg" style="width:200px;height:150px" alt="">
							</a>
						</div>
					</div>
					<!-- end col -->
					<div class="col-lg-7 col-md-12 col-sm-12 col-12">
						<div class="header-info-box">
							...
							<p>Email Us</p>
                            <h6>Verdienenglobalinvest@gmail.com</h6>
                        </div>
						<div class="header-info-box">
                            <div class="header-info-icon">
            ...
            <div class="row justify-content-center gutter-vr-30px">
                <div class="ath-container m-0">
                    <div class="ath-body">
                        ...
                        <h5 class="ath-heading title">Sign in <small class="tc-default">with your Details</small></h5>
                        ...
                        <?php } ?>
                          <form action="action/main_work.php?option=password_reset" method="POST">
                            <div class="field-item">
                                <div class="field-wrap">
                                    <input type="password" class="input-bordered" name="password" placeholder="Your password" value="<?php if (isset($_SESSION{'password'})) {echo $_SESSION['password'];}?>">
                                </div>
                            </div>
                            <div class="field-item">
                                <div class="field-wrap">
                                    <input type="password" class="input-bordered" name="new_password" placeholder="Your comfirmed_password" value="<?php if (isset($_SESSION{'new_password'})) {echo $_SESSION['new_password'];}?>">
                                </div>
                            </div>
                        ...
                        <div class="footer-logo col-12 p-0">
                            <a href="index-2.html">
								<div class="footer-logo-text">
                                    <h3>Verdienen  Global</h3>
                                    <p>Bitcoin Trading Template</p>
                                </div>
							</a>
                        </div>
                        <div class="about mb-2">
                            <p>Verdienen Global Investment is well reputed company which main businesses are Crypto & Forex Trading, Real Estate Development & Mining crypto. We have experienced traders who are working over the year in this field.</p>
                        </div>
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-12 col-12 mb-lg-0 mb-md-0 mb-5 footer-widget">
						...
						<div class="col-12 footer-widget-inner recentPost">
							...
							<div class="singleRecpost">
								...
								<h6 class="recTitle">
									<a href="#">Verdinene Global Investment has created many safety functions for these operations.</a>
								</h6>
