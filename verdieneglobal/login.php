...
<head>
	...
	<link rel="stylesheet" href="action/co.css">
        ...
        <div class="container">
            <div class="row justify-content-center gutter-vr-30px">
                <div class="ath-container m-0">
                    <div class="ath-body">
                        <h4 style="color:darkblue; text-align:center; font-size:40px position:relative">Sign in</h4>
                        <h1 style="color:darkblue; text-align:center; margin-bottom:20px; font-size:15px; position:relative">with your details</h1>
                        ...
                        <form action="action/main_work.php?option=login" method="POST">
                            <div class="field-item">
                                <div class="field-wrap">
                                    <input type="text" name="email" class="input-bordered" placeholder="Your Email" value='<?php if (isset($_SESSION{'email'})) {echo $_SESSION['email'];}?>'>
                                </div>
                            </div>
                            <div class="field-item">
                                <div class="field-wrap">
                                    <input type="password" name="password" class="input-bordered" placeholder="Password" value='<?php if (isset($_SESSION{'password'})) {echo $_SESSION['password'];}?>'>
                                </div>
                            </div>
                            ...
                            <button class="help" style=" background-color:blue">Sign In</button>
                        </form>
