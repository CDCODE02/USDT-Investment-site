				...
				<div class="row">
					<div class="col-12 text-center">
						<div class="single-page-title">
							<h2>Get In Touch</h2>
							<p>reliable and advanced digital multi-asset financial</p>
						</div>
					</div>
				</div>
				<!-- end row-->
			...
			<div class="row">
				<div class="col-12 text-center">
					<div class="section-title">
						...
						<h3>Contact <span>STABLEEARNER</span></h3>
					</div>
				</div>
			</div>
			<!-- end section title -->
			<div class="row text-center">
				...
				<div class="col-lg-3 col-md-3 col-12 mb-lg-0 mb-md-0 mb-5">
					<div class="single-address">
						...
						<div class="single-address-link">
							<a href="contact.php">quick call</a>
						</div>
					</div>
				</div>
				<!-- end col -->
				...
				<div class="col-lg-7 mx-auto">
					<div class="contact-form-wrapper">
						...
						<?php if(isset($_SESSION['formError'])){?>
                                            ...
                                            <?php } ?>
							<form  action="action/main_work.php?option=support"  method="POST">
								<div class="row">
									<div class="form-group col-12 mb-3">
										<label>Your Name:</label>
										<input name="fullname" class="form-control" id="cname" required="required" type="text" value="<?php if (isset($_SESSION{'fullname'})) {echo $_SESSION['fullname'];}?>">
									</div>
									<div class="form-group col-12 mb-3">
										<label>Your Email:</label>
										<input name="email" class="form-control" id="cemail" required="required" type="email" value="<?php if (isset($_SESSION{'email'})) {echo $_SESSION['email'];}?>">
									</div>
									<div class="form-group col-12 mb-3">
										<label>Message:</label>
										<textarea rows="6" name="message" class="form-control" id="cmessage" placeholder="Your Message Here..." required="required"value="<?php if (isset($_SESSION{'message'})) {echo $_SESSION['message'];}?>">  </textarea>
									</div>
